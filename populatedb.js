...
//Passamos o índice para as funções ...Create para que, 
//por exemplo, gênero[0] sempre seja o gênero Fantasia, 
//independentemente da ordem em que os elementos do argumento de promessa.all são concluídos.
...
async function authorCreate(index, first_name, family_name, date_birth, date_death){
    const authordetail = { first_name: first_name, family_name: family_name }
    if (date_birth !== false) authordetail.date_of_birth = date_birth
    if (date_death !== false) authordetail.date_of_death = date_death
